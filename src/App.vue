...
.app-wrap {
    ...
    .aside {
        ...
        .logo {
            ...
            padding: 5px;
            line-height: 1;
            border-bottom: 4px solid var(--cesium-link-hover-color);
            //box-shadow: 0 0 8px rgba(0, 0, 0, .2);
            ...
            .version {
                ...
                margin: 3px 3px 0 0;
                padding: 2px 4px;
                background-color: var(--cesium-link-underline-color);
                border-radius: 2px;
                font-size: 12px;
                line-height: 1;
                color: var(--cesium-color);
            }
        }
        ...
        .official {
            ul {
                ...
                margin: 0;
                padding: 5px;
                background: var(--cesium-note-background-color);
                line-height: 1;
                list-style: none;
            }
